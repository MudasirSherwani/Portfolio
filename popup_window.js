...
function createModal(i) {
  ...
  <div class="pop-up-btns">
    <a href="${ProjectObjects[i].projectLive}" class="btn btn-primary pop-up-btn white roboto">See Live<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="${ProjectObjects[i].projectSource}" class="btn roboto btn-primary pop-up-btn white github">See Source <svg width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  document.getElementById('popup-project-image').src =ProjectObjects[i].projectImg;
  document.getElementById('popup-project-desc').innerHTML=ProjectObjects[i].projectDescription;
  document.getElementById('popup-tech1').innerHTML=ProjectObjects[i].projectTechnologies[0];
  document.getElementById('popup-tech2').innerHTML=ProjectObjects[i].projectTechnologies[1];
  document.getElementById('popup-tech3').innerHTML=ProjectObjects[i].projectTechnologies[2];
  document.getElementById('popup-tech4').innerHTML=ProjectObjects[i].projectTechnologies[3];
...
const ProjectObjects = [
  {
    ...
    projectImg: 'images/Project_Image.svg',
